  ...
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        <h1 class="modal-title fs-5" id="exampleModalLabel"><asp:Label ID="lblTitle" runat="server"></asp:Label></h1>
        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
      </div>
      <div class="modal-body">
        <p><span class="text-bold">Data e hora: </span> <asp:Label ID="lblData" runat="server"></asp:Label> <br></p>
        <p><span class="font-weight-bolder">Categoria: </span> <asp:Label ID="lblCat" runat="server"></asp:Label> <br></p>
        <p><span class="text-bold">Descrição: </span> <asp:Label ID="lblDesc" runat="server"></asp:Label> </p>
        <br>
        <br>
...
<asp:TextBox ID="txtProvidencias" runat="server" placeholder="Descricao" CssClass="form-control" ClientIDMode="Static" TextMode="MultiLine" MaxLength="255"></asp:TextBox>
      ...
      <div class="modal-footer">
        <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Fechar</button>
                    <asp:LinkButton ID="btnRegistrar" runat="server" CssClass="btn btn-primary btn-block" OnClick="btnRegistrar_Click">
                        Registrar
                    </asp:LinkButton>
      </div>
    </div>
